...
function getJSON() {
	...
	var number = 1;
	var question_text = "In general, which one is faster?";
	var choice0 = 'Leader-based replication';
	var choice1 = 'Leaderless replication';
	var choice2 = 'IDK, there is not enough information.';
    ...
    var number = 2;
	question_text = 'If I have an algorithm/system works correctly in the crash-recovery model, it must work correctly in the crash-stop model.'
	choice0 = 'Yes.';
	choice1 = 'No.';
	...
	var questions = [first_question, second_question];


	var url = 'Model.mp4'; // This will change when adding JSON
	var quiz_data = {
		url: url,
		questions: questions
	};
